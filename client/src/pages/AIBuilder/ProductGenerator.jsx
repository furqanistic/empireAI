                    ...
                    <div className='space-y-6'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button
                          onClick={() =>
                            handleCopyContent(
                              JSON.stringify(generatedProduct.outline, null, 2),
                              'outline'
                            )
                          }
                          disabled={isCopying}
                    ...
                    <div className='space-y-6'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button
                          onClick={() =>
                            handleCopyContent(
                              JSON.stringify(generatedProduct.pricing, null, 2),
                              'pricing'
                            )
                          }
                          disabled={isCopying}
                    ...
                    <div className='space-y-6'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button
                          onClick={() =>
                            handleCopyContent(
                              JSON.stringify(generatedProduct.bonuses, null, 2),
                              'bonuses'
                            )
                          }
                          disabled={isCopying}
                    ...
                    <div className='space-y-6'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button
                          onClick={() =>
                            handleCopyContent(
                              JSON.stringify(generatedProduct.launch, null, 2),
                              'launch'
                            )
                          }
                          disabled={isCopying}
                      ...
                      <div className='space-y-4'>
                        {generatedProduct.launch.sequence.map((step, index) => (
                          <div
                            key={index}
                            className='bg-[#1E1E21] rounded-lg p-4'
                          >
                    ...
                    <div className='space-y-6'>
                      <div className='flex items-center justify-between'>
                        ...
                        <button
                          onClick={() =>
                            handleCopyContent(
                              JSON.stringify(generatedProduct.revenue, null, 2),
                              'revenue'
                            )
                          }
                          disabled={isCopying}
